...
public class ItemTest {
  ...
  public void setUp() {
    my_item_list = new Item[] {
      ...
      new Item("Pins", .50, 0, 1.00),
      new Item("Junk", .25, 1, 0.00)
    };
  ...
  /**
   * Tests other branches of the calculate method.
   */
  @Test
  public void testCalculatePriceOtherBranch() {
    assertEquals(1.00, my_item_list[8].calculatePriceFor(2), TOLERANCE);
  }

  /**
   * Tests if the String representation of single items are correct.
   */
  @Test
  ...
  /**
   * Tests if the String representation of the item with bulk are correct.
   */
  @Test
  ...
  /**
   * Tests the String representation for the other branches.
   */
  @Test
  public void testToStringBranches() {
    assertEquals("Item 9 toString.", "Pins, $0.50", my_item_list[8].toString());
    assertEquals("Item 10 toString.", "Junk, $0.25", my_item_list[9].toString());
  }
  ...
  public void testEqualsObjectTrue() {
    ...
    assertTrue("Test 3: Returns True.", my_item_list[1].equals(my_item_comparison[1]));
    assertTrue("Test 4: Returns True", my_item_comparison[0].equals(my_item_comparison[0]));
  ...
  public void testEqualsObjectFalse() {
    assertFalse("Test 1: Returns False.", my_item_list[0].equals(my_item_list[3]));
    assertFalse("Test 2: Returns False.", my_item_list[6].equals(my_item_list[7]));
  }
  
  /**
   * Tests the other branches of the Equals method.
   */
  @Test
  public void testEqualsObjectBranches() {
    assertFalse("Test 1.", my_item_list[0].equals(new Item("BioShock Infinite", 70.00)));
    assertFalse("Test 2.", my_item_list[4].equals(new Item("Game of Thrones Season 2 Blu-ray", 
                                                           43.00, 0, 86.00)));
    assertFalse("Test 3.", my_item_list[5].equals(new Item("Pre-owned PS3 game", 
                                                           19.99, 3, 30.00)));
    assertFalse("Test 4.", my_item_list[3].equals(new Item("Other Notes", .50, 6, 1.50)));
  }
